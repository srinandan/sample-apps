...
import (
	...
	apis "github.com/srinandan/sample-apps/keyservice/apis"
	app "github.com/srinandan/sample-apps/keyservice/app"
...
func main() {
	...
	r.HandleFunc("/key", apis.GetKeyHandler).
		Methods("GET")
	r.HandleFunc("/certs", apis.GetCertHandler).
		Methods("GET")
	r.HandleFunc("/kid", apis.GetKidHandler).
		Methods("GET")
