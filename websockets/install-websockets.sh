...
# create websockets product
apigeecli products create -o $1 -f auto -n ${proxy_name}_product -m "websockets Product" -e $2 -p $proxy_name -d "A product for websockets app"
RESULT=$?
if [ $RESULT -ne 0 ]; then
